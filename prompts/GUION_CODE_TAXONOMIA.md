...
## CONTEXTO
Hay un documento de taxonomía canónica (TAXONOMIA_FINSENSE_v2.md) que define TODAS las combinaciones Tipo > Cat1 > Cat2 permitidas. Cualquier combinación fuera de esa lista es un ERROR. Este guión aplica esa taxonomía a toda la BBDD.
...
TAXONOMIA = {
    "GASTO": {
        "Alimentación": ["Mercadona", "Lidl", "Carnicería", "Carrefour", "Cash & Carry", "Frutería", "Eroski", "Bodega", "Higinio", "Mercado", "Panadería", "Otros"],
        "Compras": ["Amazon", "El Corte Inglés", "Leroy Merlin", "Decathlon", "Aliexpress", "Online", "Tecnología", "Hogar", "Estancos", "Loterías", "Bazar", "Deportes", "Ropa y Calzado", "Otros"],
        "Restauración": ["Restaurante", "Bar", "Cafetería", "Fast food", "Heladería", "Otros"],
        "Recibos": ["Telefonía e Internet", "Luz", "Agua", "Gas", "Gimnasio", "Alarma", "Asesoría", "Donaciones", "Fotovoltaica", "Otros"],
        "Seguros": ["Casa", "Vida", "Coche", "Otros"],
        "Transporte": ["Combustible", "Peajes", "Parking", "Transporte público", "Taxi", "Taller", "Otros"],
        "Finanzas": ["Hipoteca", "Préstamos", "Ahorro", "Liquidación", "Gestoría", "Otros"],
        "Impuestos": ["IRPF", "Autónomos", "Retenciones", "IBI", "Circulación", "Pasarela/Vado", "Seguridad Social", "AEAT"],
        "Vivienda": ["Limpieza", "Mantenimiento", "Otros"],
        "Salud y Belleza": ["Farmacia", "Médico", "Dental", "Óptica", "Peluquería", "Fisioterapia", "Perfumería", "Otros"],
        "Ropa y Calzado": ["Carrefour Zaraiche", "Ropa y Accesorios", "Otros"],
        "Ocio y Cultura": ["Cines", "Entradas", "Juegos", "Otros"],
        "Deportes": ["Pádel", "Gimnasio", "Equipo deportivo", "Club"],
        "Suscripciones": ["Streaming", "Música", "Audible", "Software", "Apple", "Waylet", "Otros"],
        "Viajes": ["Alojamiento", "Vuelos", "Transporte", "Actividades", "Aeropuerto", "Otros"],
