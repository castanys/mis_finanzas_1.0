...
MERCHANT_RULES = [
    ...
    ("VENTA EL PALMERAL", "Restauración", "Restaurante"),  # Restaurante Cartagena
    ("EL CHANQUETE", "Restauración", "Restaurante"),  # Restaurante mediterráneo Cartagena
    ("CHANQUETE", "Restauración", "Restaurante"),
    ("DCUATRO", "Restauración", "Restaurante"),  # Restaurante Murcia
    ("GUEVARA", "Restauración", "Restaurante"),  # El Corral de Guevara
    ...
    ("MESON", "Restauración", "Mesón"),
     ...
     ("LA FRONTERA", "Restauración", "Restaurante"),  # La Frontera (Trade Republic S50)
     ("EL HORNO DE RICOTE", "Restauración", "Restaurante"),  # El Horno de Ricote (Trade Republic S50)
    ...
    ("AREAS LA PLANA", "Restauración", "Restaurante"),
    ...
    ("CERVERZA FRIA", "Restauración", "Restaurante"),
    ...
    ("DANIEL GONZALEZ SANCHEZ", "Restauración", "Restaurante"),
    ...
    ("EL CANTON DE", "Restauración", "Restaurante"),
    ("EL CHORRILLO", "Restauración", "Restaurante"),
    ...
    ("HIBISCUS TOWN", "Restauración", "Restaurante"),
    ...
    ("INVERSIONES SUAPO", "Restauración", "Restaurante"),
    ("JET 2", "Viajes", "Aeropuerto"),
    ("JUAN LUIS PEREZ AZNAR", "Restauración", "Restaurante"),
    ...
    ("KUMAR DONER KEBAB", "Restauración", "Restaurante"),
    ("LA CATA Y AROMAS DEL VINO", "Alimentación", "Otros"),
    ("LA HERRADURA", "Restauración", "Restaurante"),
    ("LA JIJONENCA", "Restauración", "Cafetería"),
    ("LA LAGUNA DE U¥A", "Viajes", "Alojamiento"),
    ("LACARBONERIA", "Restauración", "Restaurante"),
    ("LAVI RESTURACION", "Restauración", "Restaurante"),
    ...
    ("NUEVA BAHIA", "Restauración", "Restaurante"),
    ...
    ("PF CHANG", "Restauración", "Restaurante"),
    ("PIC NEGRE VI", "Alimentación", "Otros"),
    ("PIZZERIA", "Restauración", "Restaurante"),
    ("PIZZERIA ANGELO", "Restauración", "Restaurante"),
    ("PIZZERIA LARA", "Restauración", "Restaurante"),
    ("PIZZERIA SAPRI", "Restauración", "Restaurante"),
    ("PIZZERIA ¥AM ¥AM", "Restauración", "Restaurante"),
    ...
    ("RED LOBSTER", "Restauración", "Restaurante"),
    ...
    ("RTE. FERNANDEZ", "Restauración", "Restaurante"),
    ("Revolut", "Finanzas", "Comisiones"),
    ("SARAO GOURMET", "Restauración", "Restaurante"),
    ("SCHIPHOL", "Transporte", "Público"),
    ("SEA VIEW ALBIR", "Restauración", "Restaurante"),
    ...
    ("Satelite 20", "Restauración", "Restaurante"),
    ("SumUp *jesus ripol", "Restauración", "Restaurante"),
    ("TECTELTIC", "Compras", "Electrónica"),
    ("TESCO METRO", "Alimentación", "Supermercado"),
    ("THE AULD DUBLINER", "Restauración", "Restaurante"),
    ("TICKETMASTER", "Ocio y Cultura", "Espectáculos"),
    ("TODOHOBBY", "Compras", "Juguetes"),
    ("TOMAS GUILLEN GUILLEN", "Restauración", "Restaurante"),
